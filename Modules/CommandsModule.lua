...
local cmdslist = {
	["echo"] = function(text) module:AddOutput({"Text","TextColor3","TextTransparency"},{text,Color3.fromRGB(225, 225, 225),0},gui) end,
	...
	["sv_cheats"] = function(val)
		if tonumber(val) then
			...
			module:AddOutput({"Text","TextColor3","TextTransparency"},{"Server cvar 'sv_cheats' needs 1 integer, Server cvar is currently : nil",Color3.fromRGB(255, 44, 44),0},gui) 
		end end,
	["credits"] = function()
